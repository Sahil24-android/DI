...
class ExposedEventPaymentsAdapter(private val context: Context) : RecyclerView.Adapter<ExposedEventPaymentsAdapter.PaymentsViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ExposedEventPaymentsAdapter.PaymentsViewHolder {
    ...
    override fun onBindViewHolder(holder: ExposedEventPaymentsAdapter.PaymentsViewHolder, position: Int) {
