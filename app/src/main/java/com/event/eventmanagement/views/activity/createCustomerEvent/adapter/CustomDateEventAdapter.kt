package com.event.eventmanagement.views.activity.createCustomerEvent.adapter
...
class CustomDateEventAdapter() :
    RecyclerView.Adapter<CustomDateEventAdapter.CustomDateViewHolder>() {
    ...
    override fun onBindViewHolder(
        holder: CustomDateViewHolder, position: Int
    ) {
